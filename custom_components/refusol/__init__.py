"""
Custom integration to integrate refusol with Home Assistant.

For more details about this integration, please refer to
https://github.com/netadair/homeassistant-refusol
"""
...
async def async_setup_entry(
    ...
    entry.runtime_data = RefusolData(
